const BattleScene = new Phaser.Class({
    ...
    nextTurn: function() {  
        ...
        if(this.units[this.index] instanceof PlayerCharacter) {
            ...
            // reset heroes postion
            this.events.emit("PlayerAttackFinish", this.index);
    ...
    receivePlayerSelection: function(action, target) {
        if(action == "attack") {            
            ...
            console.log('atk unit', this.units) 
            console.log('atk index', this.index) 
            this.heroes[this.index].moveBack()
...
const UIScene = new Phaser.Class({
    ...
    {    
        ...
        this.battleScene.events.on("PlayerAttackFinish", this.onPlayerAttackFinish, this);
    ...
    onPlayerSelect: function(id) {
        ...
        this.currentMenu = this.actionsMenu;
        this.battleScene.heroes[id].moveToAttack()
        console.log('hero id',id)
    },
    onPlayerAttackFinish: function(id) {
        console.log("onPlayerAttackFinish",this)
        console.log("id",id)

        // this.battleScene.heroes[id].moveBack()
    },
